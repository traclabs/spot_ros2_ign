...
def generate_launch_description():
  ...
  launch_args = [
    ...
    DeclareLaunchArgument(
        ...
        description='...'),
    DeclareLaunchArgument('spawn_anymal', default_value='True'),
    DeclareLaunchArgument("urdf_file",
#        default_value=os.path.join( get_package_share_directory('champ_description'), 'urdf/anymal/anymal.urdf.xacro')),
    ...
    DeclareLaunchArgument(
      'world_file', default_value=os.path.join(
            get_package_share_directory("champ_gazebo"), 'worlds/search_office_world.sdf'))
  ...
  # Spawn Anymal
  spawn_anymal = IncludeLaunchDescription(
            PathJoinSubstitution([FindPackageShare('champ_bringup'), 'launch', 'anymal_spawn.launch.py']),
            ...
            condition=IfCondition(LaunchConfiguration("spawn_anymal"))
  )
